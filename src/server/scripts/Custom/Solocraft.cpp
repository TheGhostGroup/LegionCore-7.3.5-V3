...
public:
    ...
    void OnMapChanged(Player* player) override
    {
        if (solocraftConfig.SoloCraftEnable)
        {
            ...
            TC_LOG_DEBUG("solocraft", "solocraft player guid = %lu, difficulty=%f, dunLevel=%d, numInGroup=%d, classBalance=%u", player->GetGUID().GetCounter(), difficulty, dunLevel, numInGroup, classBalance);
