...
//todo: ����������� reroure power, low health, ���������� double attack
enum ScriptTexts
{
    //chimaeron
    SAY_AGGRO                       = 0,
